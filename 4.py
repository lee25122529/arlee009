...
botStart = time.time()
#==============================================================================#
line = LINE("Et01ZnOkNadjHusBSoL3.J0SdVs8cAJdB+ZuDwGJFWW.smNZqBZbHb+Vi/oOVDt1n3cRL3sOOtIz9eNmgRgXAsE=")
line.log("Auth Token : " + str(line.authToken))
line.log("Timeline Token : " + str(line.tl.channelAccessToken))

ki = LINE('EtexByg4LDBfRjKP3bEc.YPkEVMBbOXgsW9QJbkHMZa.dhbDETdfMGBDK0mB854xPfWDzx0JmvQsxuzCo3TxCQ8=')
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Timeline Token : " + str(ki.tl.channelAccessToken))

kk = LINE('EtQViPORX0z2L3NvY4bb.WBQZZ1QFZQzf1iEHKIqWQW.MWPDvD0p0tuWrSM0OT9nvpKuaETq7kxiOsMSaXxvKG0=')
kk.log("Auth Token : " + str(kk.authToken))
kk.log("Timeline Token : " + str(kk.tl.channelAccessToken))

kc = LINE('EtmW1antipYbZfdPfrUa.ZJpIFhLtVX30pWjcbxTMEG.1lX7ehF6Kfj/O1BPoDdjHJTqn7Am9NAUJVW97tEX9Do=')
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Timeline Token : " + str(kc.tl.channelAccessToken))

ke = LINE('EtWbhCXNAa84iCJEJH63.416oXTDF+JlqqJXvmml5iW.VUlD2FgzfB2XetaW6dcESLGALImO2pdy4buc8LbP2DY=')
...
Family=["u8f4b03bd2f026a30dbff351d5a08dfc",lineMID]
...
settings = {
    ...
    "cName":"",
    "cNames":"",
    "welcome":"สนใจเชลบอท-บอทวี10ติดต่อได้ที่นี้╭∩╮(-_-)╭∩╮ http://line.me/ti/p/~arlee006",
    "Nk":"😱อุ๊ต๊ะ😱",
    "bye":"🙌บาย..",
    "invite": {},
    "winvite": False,
...
fukgerMessage = ["หัวดอ","กาก","พ่องตาย","สัส","เหี้ย","ควย","แตด","สาสส","แม่มึงอ่ะ","กวนตีน","เลว","ระยำ","ควาย","เย็ดแม่","เย็ดเข้","ตอแหล","ดอกทอง","ช้างเย็ด"]
...
def myhelp():
    myHelp =      " 【คำสั่ง  ➾ เรียกดูคำสั่ง】"+ "  \n" + \
                  ...
                  " 【รายการบล็อค  ➾ รายการที่ถูกบล็อค】"+ "  \n" + \
                  " 【รายการmid  ➾ midเพื่อนทั้งหมด】"+ "  \n" + \
...
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in fukgerMessage:
                    random.choice(Rfu).kickoutFromGroup(receiver,[sender])
                    random.choice(Rfu).sendText(msg.to,"ตรวจพบผู้ใช้คำหยาบในกลุ่ม จำเป็นต้องนำออก เพื่อความสงบเรียบร้อยภายในกลุ่ม (๑¯ω¯๑)")
        ...
        if op.type == 19:
           ...
           if settings["Nk"] == True:
             ...
             #line.sendContact(op.param2,contact)  
             line.sendImageWithURL(op.param1,image)
             line.sendMessage(msg.to, None, contentMetadata={"STKID":"23701829","STKPKGID":"1740802","STKVER":"1"}, contentType=7)
        ...
        if op.type == 15:
           ...
           if settings["Nn"] == True:
             ...
             #line.sendContact(op.param1,contact)  
             line.sendImageWithURL(op.param1,image)
