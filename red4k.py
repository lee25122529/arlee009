...
ki = LINE('Euk2sT9jdKFKa9eW2mkd.MJjB5RM02td4rFyvdkvFtq.jcUoKhuhOi4JRPDgjnw9pbafWjBoJbnVIt8C/LACHyU=')
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Timeline Token : " + str(ki.tl.channelAccessToken))

kk = LINE('EurzDbEMG5gLen0KC1xe.suxc3CYHYuNtF8LZD0ehhG.ut5W6DDdoUF2mDYzFdcRsyUqehCAK4IAfWy4QxktYTs=')
kk.log("Auth Token : " + str(kk.authToken))
kk.log("Timeline Token : " + str(kk.tl.channelAccessToken))

kc = LINE('EubU8bHpFuq6SA4amLwc.ovqvmfGzvKpMHoOPQ4Gpta.ym1Y2t0GqlunM6M87zklAG1E6/OTvRpRcD1hMPWcxwY=')
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Timeline Token : " + str(kc.tl.channelAccessToken))

ke = LINE('Eu8GbxbsBpk75U5xnEgc.Q9DC+bYJIZLrFrpcIAmSda.HA+kCOQhdz+HVEhFkcLrP3biNgaaaahzbGTmnFR/jI4=')
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["ป๊า","ป๊าเรส","ลุง","เรส","นาย","เพื่อน","จาร์ย","อาจาร์ย","เฮีย"]:
                    line.sendText(msg.to, str(settings["comment"]))
