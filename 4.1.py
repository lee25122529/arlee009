...
botStart = time.time()
#==============================================================================#
line = LINE("EtzwRNj6L7ILfuLffH33.J0SdVs8cAJdB+ZuDwGJFWW.yMkjpju9f35TAJEIWON1BBe679xjff44EqMx8DFOg+I=")
line.log("Auth Token : " + str(line.authToken))
line.log("Timeline Token : " + str(line.tl.channelAccessToken))

ki = LINE('EtObhtUrhNCR9jqWS8G6.lGN4ezJX3TJyeUOorijdXG.YYlEG7RVWxL+VPbIlRsJ3VKYLZc7HnnXt18qtTPvhRA=')
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Timeline Token : " + str(ki.tl.channelAccessToken))

kk = LINE('Etfg49rGZJSjd9ci9XLe.XiugtLzUw9nsogKTFJ47ZG.PgNUa+uVj+UQ6kE0M8n+i5Pl02c3maWeWlkY/N0AUfs=')
kk.log("Auth Token : " + str(kk.authToken))
kk.log("Timeline Token : " + str(kk.tl.channelAccessToken))

kc = LINE('Et8j1Sqm4pt2hBxxria0.3G3xi3hWvNjZvQx8dvA0ma.HcwBNSiR6dwGJrKHkFco1p9IbmPU4OCP0cgYhrXq9gM=')
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Timeline Token : " + str(kc.tl.channelAccessToken))

ke = LINE('EtQMg8aD2LlwRd1n1lSf.dKdXWnp2nImnLKzk8KT97W.+7E27B+lBrl9g5/zmCYgBkVkUy6SeVDA7Ju3/TZ4+bM=')
...
settings = {
    ...
    "pname": {},
    "pro_name": {},
    "message":"บัญชีนี้ถูกป้องกันโดย Selfbot By ™❍✯͜͡RED™SAMURI✯͜͡❂➣ระบบได้ทำการบล็อคคุณอัตโนมัติเนื่องจากคุณยังไม่ได้ยืนยันตัวตนกับผู้สร้างบอท\nสามารถยืนตัวตนได้ง่ายโดยการพิมunblockกับ™❍✯͜͡RED™SAMURI✯͜͡❂➣ระบบจะทำการปลดบล็อคท่านโดยอัตโนมัต",
    "comment":"Thanks for add me Selfbot By ™❍✯͜͡RED™SAMURI✯͜͡❂➣",
    "Respontag":'https://youtu.be/9S0J0wosgy แท็กจังกุรู้ว่าเงี่ยนนั่น http://www.google.co.kr/url?sa=t&source=web&cd=20&ved=0CJcBEBYwEw&url=http%3A%2F%2Fwww.anysexmovies.com%2F&ei=KwK8UcStFMXniAeCoYBI&usg=AFQjCNEeL8WjQGTsLIZwXYEMZ50uGGc6gw&sig2=dr01CCJKOayvSkp4jRCOWA',
    "userAgent": [
...
mulai = time.time()
dangerMessage = ["cleanse","group cleansed.","mulai",".winebot",".kickall","mayhem","kick on","Kick","!kickall","nuke","บิน","Kick","กระเด็น","ปวดตับ","เซลกากจัง","เตะ",".","ปลิว"]
...
def myhelp():
    myHelp =      " 【คำสั่ง  ➾ เรียกดูคำสั่ง】"+ "  \n" + \
                  " 【คำสั่ง2  ➾ เรียกดูคำสั่งที่2】"+ "  \n" + \
                  " 【คำสั่ง3  ➾ เรียกดูคำสั่งที่3】"+ "  \n" + \
                  " 【รีบูส  ➾ รูบูสระบบ】"+ "  \n" + \
                  " 【เช็คออน์   ➾ เช็คเวลาทำงานบอท】"+ "  \n" + \
                  " 【ข้อมูล  ➾ เช็คข้อมูลไลน์】"+ "  \n" + \
                  " 【เช็คค่า  ➾ เช็คระบบตั้งค่า】"+ "  \n" + \
                  " 【ไอดี  ➾ ดูmidเรา】"+ "  \n" + \
                  " 【ชื่อ  ➾ ดูชื่อไลน์】"+ "  \n" + \
                  " 【รูป  ➾ ดึงรูปโปรไฟล】"+ "  \n" + \
                  " 【วิดีโอ  ➾ ดึงวิดีโอโปรไฟล】"+ "  \n" + \
                  " 【ปก  ➾ ดึงภาพปก】"+ "  \n" + \
                  " 【คท@  ➾ ดึงคอนแทค】"+ "  \n" + \
                  " 【ชื่อ@  ➾ ดึงชื่อ】"+ "  \n" + \
                  " 【ตัส@  ➾ ดึงตัส】"+ "  \n" + \
                  ...
                  " 【แจ๊ะ  ➾ สั่งแท็คคนทั้งหมด】"+ "  \n" + \
                  " 【จับ  ➾ เปิดระบบจับคนอ่าน】"+ "  \n" + \
                  " 【อ่าน  ➾ ดูรายชื่อคนอ่าน】"+ "  \n" + \
                  " 【ค้นหารูป ➾ ค้นหารูปจากgoogle】"+ "  \n" + \
                  " 【ไอจี  ➾ หาอินสตาแกรม】"+ "  \n" + \
                  " 【การ์ตูน  ➾ ค้นหารูปจากgoogle】"+ "  \n" + \
                  " 【ยูทูป  ➾ ค้นหายูทูป】"+ "  \n" + \
                  " 【เช็คเพื่อน  ➾ เช็ครายชื่อเพื่อนเรา】"+ "  \n" + \
                  " 【เช็คบล็อค  ➾ รายการที่ถูกบล็อค】"+ "  \n" + \
                  " 【เช็คmid  ➾ midเพื่อนทั้งหมด】"+ "  \n" + \
                  " 【เชิญแอด  ➾ เชิญแอดกลุ่ม】"+ "  \n" + \
                  " 【ออก  ➾ สั่งตัวเองออกจากห้อง】"+ "  \n" + \
                  " 【ถอนกำลัง  ➾ สั่งคลิ้กออก】"+ "  \n" + \
                  " 【ลบรัน  ➾ ลบห้องรันตัวเอง】"+ "  \n" + \
                  " 【1ลบรัน  ➾ ลบห้องรันคิก】"+ "  \n" + \
                  " 【เชิญ  ➾  เชิญด้วยคท】"+ "  \n" + \
                  " 【หวด@  ➾ ลบคน】"+ "  \n" + \
                  " 【เชิญ@  ➾ เชิญคน】"+ "  \n" + \
                  ...
                  " 【ออกทุกกลุ่ม  ➾ ออกจากทุกกลุ่ม】"+ "  \n" + \
                  " 【ตัส:   ➾ เปลี่ยนตัสเรา】"+ "  \n" + \
                  " 【ชื่อ:   ➾ เปลี่ยนชื่อเรา】"+ "  \n" + \
                  " 【ชื่อคิก:   ➾ เปลี่ยนชื่อคิก】"+ "  \n" + \
                  " 【ตัสคิก:   ➾ เปลี่ยนตัสคิก】"+ "  \n" + \
                  " 【1ลบรัน  ➾ ลบรัน】"+ "  \n" + \
                  " 【เช็คดำ  ➾ เช็ครายการดำ】"+ "  \n" + \
                  ...
                  " 【เปิดคนออก  ➾ เปิดระบบทักคนออก】"+ "  \n" + \
                  " 【ปิดคนออก  ➾ ปิดระบบทักคนออก】"+ "  \n" + \
                  " 【เปิดคนลบ  ➾ เปิดกล่าวถึงคนลบ】"+ "  \n" + \
                  " 【ปิดคนลบ  ➾ ปิดกล่าวถึงคนเลบ】"+ "  \n" + \
                  " 【แท็กเปิด】➾ เปิดกล่าวถึงคนแทค】"+ "  \n" + \
                  " 【แท็กปิด】➾ปิดกล่าวถึงคนแทค】"+ "  \n" + \
                  " 【แท็กเจ็บเปิด】➾ปิดเตะคนแทค"+ "  \n" + \
                  " 【แท็กเจ็บปิด】➾ปิดเตะคนแทค"+ "  \n" + \
                  " 【ทักออก:   ➾ ตั้งข้อความทักคนเข้า】"+ "  \n" + \
                  " 【ทักเข้า:  ➾ ตั้งข้อความทักคนออก】"+ "  \n" + \
                  " 【ทักเตะ:   ➾ ตั้งข้อความทักคนเตะ】"+ "  \n" + \
                  " 【ตั้งแท็ก:   ➾ ตั้งข้อความทักคนแท็ก】"+ "  \n" + \
                  " 【ลบเชิญs ➾ ลบค้างเชิญ】"+ "  \n" + \
                  " 【เปิดแสกน   ➾ตรวจจับคนอ่าน 】"+ "  \n" + \
                  " 【ปิดแสกน   ➾ปิดจับคนอ่าน】"+ "  \n" + \
                  " 【urban   ➾ขาว 】"+ "  \n" + \
                  " 【Gcancel.:+จำนวน ➾ ยกเลิกห้องเชิญ】"+ "  \n" + \
                  " 【Gcancel.:off ➾ ปิดระบบยกเลิกห้อง】"+ "  \n" + \
                  " 【Copy @  ➾ คัดลอกคนอื่น】"+ "  \n" + \
                  " 【me  ➾ คทเรา】"+ "  \n" + \
                  " 【โย่ว ➾ คทเรา】"+ "  \n" + \
                  " 【คทล่อง  ➾ ดูคทคนไส่ล่องหน】"+ "  \n" + \
                  " 【แทคล่อง  ➾ แทคคนไส่ล่องหน】"+ "  \n" + \
                  " 【ไอดีล่อง  ➾ ดูไอดีคนไส่ล่องหน】"+ "  \n" + \
                  " 【ลงดำ  ➾ แบนหมด】"+ "  \n" + \
                  " 【แบน @  ➾ บชดำ】"+ "  \n" + \
                  " 【ลบแบน @  ➾ บชขาว】"+ "  \n" + \
                  " 【วีดีโอ @  ➾ ดึงรูปวิดีโอ】"+ "  \n" + \
                  ...
                  " 【Bcvoice➾ส่งข้อความเสียงทุกกลุ่ม 】"+ "  \n" + \
                  " 【Cbcvoice➾ ส่งข้อความเสียงทุกแชท】"+ "  \n" + \
                  " 【wikipedia  +ข้อความ  ➾ ค้าหาข้อความ】"+ "  \n" + \
                  " 【ปฏิทิน  ➾ เช็ควันและเวลา】"+ "  \n" + \
                  " 【Spam  on +เลข+ข้อความ】  ➾ "+ "  \n" + \
                  " 【ล้างดำ  ➾ ล้างบชดำ】"+ "  \n" + \
                  " 【องครักษ์  ➾ สั่งคลิ้กเข้า】"+ "  \n" + \
                  " 【1-3 @  ➾ สั่งคลิ้กเตะ】"+ "  \n" + \
                  " 【ปวดตัป  ➾ สั่งคลิ้กบิน】"+ "  \n" + \
                  " 【เปิดกัน  ➾ เปิดป้องกัน】"+ "  \n" + \
                  " 【ปิดกัน  ➾ ปิดป้องกัน】"+ "  \n" + \
                  " 【กันยก  ➾ เปิดป้องกันยกเชิญ】"+ "  \n" + \
                  " 【ปิดกันยก  ➾ ปิดป้องกันยกเชิญ】"+ "  \n" + \
                  " 【กันเชิญ  ➾ เปิดป้องกันคนเชิญ】"+ "  \n" + \
                  " 【ปิดกันเชิญ  ➾ ปิดป้องกันคนเชิญ】"+ "  \n" + \
                  " 【กันลิ้ง  ➾ เปิดป้องกันลิ้งค์】"+ "  \n" + \
                  " 【ปิดกันลิ้ง  ➾ ปิดป้องกันลิ้งค์】"+ "  \n" + \
                  " 【กันสมาชิก  ➾ เปิดป้องกันสมาชิก】"+ "  \n" + \
                  " 【ปิดกันสมาชิก  ➾ ปิดป้องกันสมาชิก】"+ "  \n" + \
                  " 【กันเข้า  ➾ เปิดป้องกันคนเข้า】"+ "  \n" + \
                  " 【ปิดกันเข้า  ➾ ปิดป้องกันคนเข้า】"+ "  \n" + \
                  " 【BY ™❍✯͜͡RED™SAMURAI✯͜͡❂➣】"
    return myHelp
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "  ™❍✯͜͡RED™SAMURAI✯͜͡❂➣")
                    ...
                    line.sendMessage(to, "กรุณาให้ตัวหลักล็อคอินลิ้งค์ใหม่.")
#                    line.sendMessage(to, "Success Restarting.")
                    ...
                    try:
                        ...
                        ret_ += "\nตัส ✈️  {}".format(contact.statusMessage)
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "   ™❍✯͜͡RED™SAMURI✯͜͡❂➣ ")
...
#===================================================================#              
                    ...
                    if receiver in read['readPoint']:
                        ...
                        line.sendMessage(receiver,"สั่งจับใหม่แล้วสั่งอ่านใหม่อีกรอบ ")
                    ...
                    for k in range(0, len(bulan)):
                        if bln == str(k): bln = bulan[k-1]
                    readTime = hasil + "ที่ " + timeNow.strftime('%d') + " - " + bln + " - " + timeNow.strftime('%Y') + "\nเวลา : [ " + timeNow.strftime('%H:%M:%S') + " ]"
                ...
                elif msg.text in ["แท็กเจ็บเปิด"]:
                    settings["kickMention"] = True
                    line.sendMessage(msg.to,"เปิดระบบเตะคนแท็ก")
                
                elif msg.text in ["แท็กเจ็บปิด"]:
                    ...
                    line.sendMessage(msg.to,"ปิดระบบข้อความแท็ก")
                        ...
                        line.sendMessage(msg.to,"╭∩╮(-_-)╭∩╮ปิดแทครูปเรียบร้อย╭∩╮(-_-)╭∩╮")
                  ...
                  if msg._from in admin:
                    ...
                    if msg._from in Family:
                        ...
                        line.sendMessage(msg.to,"ok เปลี่ยนชื่อของคุณแล้ว ดังนี้ 👇\n" + string)
                        print ("Update Name")
                    ...
                    if msg._from in Family:
                        ...
                        line.updateProfile(profile_A)
                        line.sendMessage(msg.to,"ok คุณได้เปลี่ยนสเตตัสของคุณแล้ว เป็น  " + string)
...
#==============FINNISHING PROTECT========================#
                ...
                elif msg.text.lower() == 'เปิดคนลบ':
                        if settings["Nk"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดข้อความคนลบสมาชิก")
                        else:
                            settings["Nk"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดข้อความคนลบสมาชิก")
                elif msg.text.lower() == 'ปิดคนลบ':
                        if settings["Nk"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"ปิดข้อความคนลบสมาชิก")
                        else:
                            settings["Nk"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"ปิดข้อความคนลบสมาชิก")
...
#==============================================================================#
        ...
        if op.type == 17:
           ...
           if settings["Sd"] == True:
             ...
             line.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net{}".format(contact.picturePath))
